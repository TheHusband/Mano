      ...
      >
        ...
        >
          <div className="flex gap-x-5">
            ...
            >
              Welcome to Mano, Mano is an open-source AI tool by
              Mintplex Labs that turns anything into a trained chatbot you can
              query and chat with. Mano is a BYOK (bring-your-own-keys)
        ...
        >
          <div className="flex gap-x-5">
            ...
            <span
              className={`whitespace-pre-line text-white font-normal text-sm md:text-sm flex flex-col gap-y-1 mt-2`}
            >
              Mano is the easiest way to put powerful AI products like
          ...
          <div className="flex gap-x-5">
            ...
            <div>
              <span
                className={`whitespace-pre-line text-white font-normal text-sm md:text-sm flex flex-col gap-y-1 mt-2`}
              >
                Mano can run totally locally on your machine with little
        ...
        >
          <div className="flex gap-x-5">
            ...
            <span
              className={`whitespace-pre-line text-white font-normal text-sm md:text-sm flex flex-col gap-y-1 mt-2`}
            >
              Mano is more than a smarter Dropbox.
              <br />
              <br />
              Mano offers two ways of talking with your data:
              <br />
              <br />
